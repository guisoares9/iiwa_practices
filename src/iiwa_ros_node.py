...
class iiwa_socket:
    ...
    def __init__(self, ip, port):
        ...
        try:
            ...
            _thread.start_new_thread( self.socket, (ip, port, ) )
        except:
    ...
    def send(self, cmd):
        _thread.start_new_thread( self.__send, (cmd, ) )
    def __send(self, cmd):
